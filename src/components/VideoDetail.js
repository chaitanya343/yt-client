...
const VideoDetail = props => {
    ...
    const channelSrc = `https://www.youtube.com/channel/watch?v=${props.video.snippet.channelId}`
    ...
    return (
        <div>
            ...
            <div className='ui segment' style={{backgroundColor: props.theme}} >
                ...
                <a className="ui black basic button" href={channelSrc}>Visit this channel on youtube.com</a><br/><br/>
